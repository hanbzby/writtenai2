...
// NOTE: do NOT call refreshData() here — that would dispatch REFRESH_STUDENT_DATA again → infinite loop.
// The store already has the latest data merged in by dispatch(). Just re-render.
